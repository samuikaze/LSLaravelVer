...
FlipBook.prototype = {
    ...
    onButtonNoteClick: function(e) {
        ...
        if (this.bStartNote) this.btnNote.style.backgroundColor = "#ff00ff";
        else this.btnNote.style.backgroundColor = "";
        this.HideBarOnPhone()
    },
    onButtonMaskClick: function(e) {
        ...
        if (this.bStartHighLight) this.btnMask.style.backgroundColor = "#ff00ff";
        else this.btnMask.style.backgroundColor = "";
        this.HideBarOnPhone()
    },
    resetZoom: function() {
        this.startZoomGesture = false;
    ...
    updateVideoLayout: function() {
        ...
        while (_g1 < _g) {
            ...
            var dom = list[i];
            var _g3 = 0,
            _g2 = RunTime.book.videos.length;
            while (_g3 < _g2) {
                var j = _g3++;
    ...
    loadCtxHighLights: function() {
        ...
        if (RunTime.book != null && RunTime.book.highlights != null) {
            ...
            if (this.currentPageNum != null) current = this.currentPageNum;
            var _g1 = 0,
            _g = RunTime.book.highlights.length;
            while (_g1 < _g) {
                var i = _g1++;
    ...
    loadCtxButtons: function() {
        ...
        if (RunTime.book != null && RunTime.book.buttons != null) {
            ...
            if (this.currentPageNum != null) current = this.currentPageNum;
            var _g1 = 0,
            _g = RunTime.book.buttons.length;
            while (_g1 < _g) {
                var i = _g1++;
                var item = RunTime.book.buttons[i];
                if (item.pageNum == current) buttons.push(item);
                else if (item.layer == "foreground") buttons.push(item)
            }
        }
    ...
    getCurrentBBV: function() {
        if (this.bottomBar.style.display == "inline-block") return "1";
        else return "0"
    },
        ...
        if (this.isAutoFliping == true) {
            ...
            this.flipTweener.onChange = function(count) {
                ...
                if (self.canTurnRight() == true) {
                    if (RunTime.book.rightToLeft) self.turnPage( - 1);
                    else self.turnPage(1)
                } else self.stopFlip()
            };
    ...
    checkIfExistBookmark: function(pageNum) {
        var i = 0;
        var _g1 = 0,
        _g = RunTime.book.bookmarks.length;
        while (_g1 < _g) {
            var i1 = _g1++;
    ...
    addBookmark: function(layout, text) {
        ...
        if (layout == -1) {
            if (RunTime.book.rightToLeft) bookmark.pageNum = this.rightPageNum;
            else bookmark.pageNum = this.leftPageNum
        } else if (layout == 1) {
            if (RunTime.book.rightToLeft) bookmark.pageNum = this.leftPageNum;
            else bookmark.pageNum = this.rightPageNum
    ...
    removeBookmark: function(pageNum) {
        ...
        while (_g1 < _g) {
            var i1 = _g1++;
            haxe.Log.trace(RunTime.book.bookmarks[i1].pageNum, {
                fileName: "FlipBook.hx",
                lineNumber: 2028,
                className: "FlipBook",
                methodName: "removeBookmark"
            });
            if (pageNum + 1 != RunTime.book.bookmarks[i1].pageNum) tmp.push(RunTime.book.bookmarks[i1]);
            else currentBookmark = RunTime.book.bookmarks[i1]
        }
    ...
    searchCore: function(pages) {
        ...
        if (list == null || list.length == 0) resultsDom.innerHTML = "0 " + L.s("SearchResults", "Search Results") + ".";
        else resultsDom.innerHTML = core.HtmlHelper.toSearchResultHtml(list)
    },
    ...
    resetAndShowTopBar: function(type) {
        ...
        if (type == "text") self.setVisible(self.topFullTextContent, true);
        else self.setVisible(self.topBarContent, true);
    ...
    setVisible: function(dom, val) {
        if (val == true) dom.style.display = "inline";
    ...
    loadCtxHotlinks: function() {
        ...
        if (RunTime.book != null && RunTime.book.hotlinks != null) {
            ...
            if (this.currentPageNum != null) current = this.currentPageNum;
            var _g1 = 0,
            _g = RunTime.book.hotlinks.length;
            while (_g1 < _g) {
                var i = _g1++;
    ...
    loadCtxSlideshow: function() {
        ...
        if (RunTime.book != null && RunTime.book.slideshows != null) {
            ...
            if (this.currentPageNum != null) current = this.currentPageNum;
            var _g1 = 0,
            _g = RunTime.book.slideshows.length;
            while (_g1 < _g) {
                var i = _g1++;
    ...
    onTouchMove: function(e) {
        ...
        if (this.zoomStatus == core.ZoomStatus.zoomed && this.startMoveGesture) {
            ...
            haxe.Log.trace(this.zoom.style.cssText, {
                fileName: "FlipBook.hx",
                lineNumber: 1480,
                className: "FlipBook",
    ...
    onTouchEnd: function(e) {
        ...
        if (this.startZoomGesture) {
            if (Math.abs(js.Lib.window.innerWidth - RunTime.clientWidth) >= 10) this.hideBottomBar();
            else if (this.bShowBottomBar) this.showBottomBar(null)
        }
    ...
    zoomIn: function(page, point0, point1) {
        if (page == null) return;
        if (!page.locked) this.zoomLeftPage.src = page.getBigPageUrl();
        else {}
    ...
    zoomAt: function(point0, point1) {
        ...
        if (this.currentPageNum != null) num = this.currentPageNum;
        var page = RunTime.getPage(num);
        if (point0 == null || point1 == null) this.zoomOut();
        else this.zoomIn(page, point0, point1)
    },
    ...
    onTouchStart: function(e) {
        ...
        if (this.bStartHighLight) {
            ...
            if (RunTime.singlePage) this.currentHighLight.tpageNum = this.getCurrentPageNum();
            else if (RunTime.book.rightToLeft) {
                if (this.currentHighLight.tx > RunTime.clientWidth / 2) this.currentHighLight.tpageNum = this.leftPageNum - 1;
                else this.currentHighLight.tpageNum = this.rightPageNum - 1
            } else if (this.currentHighLight.tx > RunTime.clientWidth / 2) this.currentHighLight.tpageNum = this.rightPageNum - 1;
            else this.currentHighLight.tpageNum = this.leftPageNum - 1;
            return
        }
        if (this.bStartNote) {
            ...
            this.gestureLastX = touch.pageX;
            this.gestureLastY = touch.pageY;
            if (RunTime.singlePage) this.currentNote.tpageNum = this.getCurrentPageNum();
            else if (RunTime.book.rightToLeft) {
                if (this.currentNote.tx > RunTime.clientWidth / 2) this.currentNote.tpageNum = this.leftPageNum - 1;
                else this.currentNote.tpageNum = this.rightPageNum - 1
            } else if (this.currentNote.tx > RunTime.clientWidth / 2) this.currentNote.tpageNum = this.rightPageNum - 1;
            else this.currentNote.tpageNum = this.leftPageNum - 1;
            return
        }
        var date = new Date();
        if (this.lastTouchTime != null) {
            ...
            if (newTime - lastTime < RunTime.doubleClickIntervalMs) {
                ...
                if (this.zoomStatus == core.ZoomStatus.zoomed) {} else {}
                return
            }
        }
    ...
    onMouseTouchStart: function(e) {
        ...
        if (this.onButtonLinkClick(xInBook, yInBook)) this.startMoveGesture = false;
        else this.startMoveGesture = true;
        this.touchStartX = touch.clientX;
        this.touchStartY = touch.clientY;
        this.lastTouchX = this.touchStartX;
        this.lastTouchY = this.touchStartY
    ...
    turnToLastPage: function(e) {
        ...
        this.clearZoom();
        this.stopFlip();
        if (RunTime.book.rightToLeft) this.turnToPage(0);
        else this.turnToPage(RunTime.book.pages.length - 1)
    },
    turnToFirstPage: function(e) {
        if (this.topMenuBarBg.style.opacity == 0) return;
        this.clearZoom();
        this.stopFlip();
        if (RunTime.book.rightToLeft) this.turnToPage(RunTime.book.pages.length - 1);
        else this.turnToPage(0)
    },
    ...
    turnPage: function(pageOffset) {
        ...
        this.tweener.onChange = function(count) {
            ...
            if (RunTime.book.rightToLeft) self.bookContext.pageOffset = pageOffset * ratio;
            else self.bookContext.pageOffset = -pageOffset * ratio;
    ...
    onMouseDown: function(e) {
        ...
        if (Math.abs(js.Lib.window.innerWidth - RunTime.clientWidth) < 10) {
            if (this.topMenuBarBg.style.opacity != RunTime.bottomBarAlpha) this.showBottomBar(e);
            else this.hideBottomBar(e)
        }
    },
...
//      var obj = e;
//      haxe.Log.trace("pointDown", {
//          fileName: "FlipBook.hx",
//          lineNumber: 377,
//          className: "FlipBook",
//          methodName: "pointDown"
//      });
...
//      this.maskGesture.target = eval("document.getElementById('mask')");
    ...
    getZoomInMoveCSS: function(x, y, atonce) {
        if (atonce) return this.zoomCSS + "-ms-transform:scale(" + this.zoomLevel + " );-ms-transition: all 0ms ;transform:scale(" + this.zoomLevel + " ) ;transition: all 0ms ;top:" + (this.currentOrgY + y | 0) + "px;left:" + (this.currentOrgX + x | 0) + "px;";
        else return this.zoomCSS + "-ms-transform:scale(" + this.zoomLevel + " );-ms-transition: all 500ms ;transform:scale(" + this.zoomLevel + " ) ; transition: all 500ms ;top:" + (this.currentOrgY + y | 0) + "px;left:" + (this.currentOrgX + x | 0) + "px;"
    },
...
var DoubleFlipBook=function(){this.mainAdLayout="center";this.mainAdDockPos="halfpage";FlipBook.call(this)};
...
DoubleFlipBook.prototype = $extend(FlipBook.prototype, {
        ...
        if (RunTime.book != null && RunTime.book.buttons != null) {
            ...
            while (_g1 < _g) {
                ...
                if (match != 0 && item.layer == "onpage") {
                    ...
                    if ((item.pageNum + 1) % 2 != 0) item.pageLayoutType = 1;
                    else item.pageLayoutType = -1;
                    buttons.push(item)
    ...
    updateAds: function() {
        try {
            if (this.currentPageNum == 0) this.mainAdHtml.style.display = "block";
            else this.mainAdHtml.style.display = "none"
        } catch(ex) {}
    },
    requestMainAd: function() {
    ...
    zoomAt: function(point0, point1) {
        ...
        if (this.currentPageNum != null) num = this.currentPageNum;
        var pair = this.getCurrentPair();
        if (point0 == null || point1 == null) this.pageZoomOut();
        else this.pageZoomIn(pair, point0, point1)
    },
    pageZoomIn: function(page, point0, point1) {
        if (page == null) return;
        if (page.leftPage != null) {
            if (!page.leftPage.locked) this.zoomLeftPage.src = page.leftPage.getBigPageUrl();
            else {}
            this.zoomLeftPage.style.display = "inline"
        }
        if (page.rightPage != null) {
            if (!page.rightPage.locked) this.zoomRightPage.src = page.rightPage.getBigPageUrl();
            else {}
        ...
        var update = function(val) {
            ...
            if (dstPageOffset > 0) {
                if (RunTime.book.rightToLeft) {
                    if (downLeft != null) {
                        if (val <= 0.5) downLeft.drawParams = ldp;
                        else downLeft.drawParams = ldp.sliceRight(2 - val * 2)
                    }
                    if (downRight != null) {}
                    ...
                    if (downLeft != null) {
                        if (val <= 0.5) downLeft.drawParams = ldp;
                        else downLeft.drawParams = ldp.sliceLeft(2 - val * 2)
                    }
                    if (downRight != null) {}
                ...
                if (RunTime.book.rightToLeft) {
                    if (downLeft != null) {
                        if (val <= 0.5) downLeft.drawParams = ldp.sliceLeft(1 - 2 * val);
                        else downLeft.drawParams = null
                    }
                    if (downRight != null) {
                        if (val <= 0.5) downRight.drawParams = rdp;
                        else downRight.drawParams = rdp.sliceLeft(2 - val * 2)
                    }
                    if (upLeft != null) upLeft.drawParams = ldp.sliceRight(val);
                    if (upRight != null) upRight.drawParams = rdp.sliceLeft(val, rdp.dw * 2 * (1 - val))
                } else {
                    if (downLeft != null) {
                        if (val <= 0.5) downLeft.drawParams = ldp.sliceRight(1 - 2 * val);
                        else downLeft.drawParams = null
                    }
                    if (downRight != null) {
                        if (val <= 0.5) downRight.drawParams = rdp;
                        else downRight.drawParams = rdp.sliceRight(2 - val * 2)
                    }
    ...
    getCurrentPageAudios: function() {
        ...
        while (_g1 < _g) {
            var i = _g1++;
            var item = audios[i];
            if (item.pageNum == lftPg) match.left = item;
            else if (item.pageNum == rtPg) match.right = item
        }
        return match
    },
    getFullText: function(pages) {
...
var List=function(){this.length=0};
List.__name__ = true;
List.prototype = {
    map: function(f) {
        var b = new List();
...
RunTime.onFullscreenChange=function(e){var obj=e;haxe.Log.trace(e,{fileName:"RunTime.hx",lineNumber:205,className:"RunTime",methodName:"onFullscreenChange"})}
...
RunTime.requestLanguages = function(callbackFunc) {
    orc.utils.Util.request(RunTime.urlLang,
    function(data) {
...
RunTime.preRequestBookInfo = function() {
    orc.utils.Util.request(RunTime.urlBookinfo,
    function(data) {
...
RunTime.requestSlideshow = function(onSuccess) {
    orc.utils.Util.request(RunTime.urlSlideshow,
    function(data) {
...
RunTime.requestHotlinks = function(onSuccess) {
    orc.utils.Util.request(RunTime.urlHotlinks,
    function(data) {
        var dom = new DOMParser();
        var ctx = new Xml2Html();
...
RunTime.requestVideos = function(onSuccess) {
    orc.utils.Util.request(RunTime.urlVideos,
    function(data) {
...
RunTime.reauestAudios = function(onSuccess) {
    orc.utils.Util.request(RunTime.urlAudios,
    function(data) {
...
RunTime.requestBookmark = function() {
    orc.utils.Util.request(RunTime.urlBookmarks,
    function(data) {
...
RunTime.useAnalyticsUA=function(ua,id){if(RunTime.isNullOrEmpty(ua))return;try{RunTime.trackerId=id;var gat=_gat;RunTime.tracker=gat._getTracker(ua);RunTime.tracker._initData()}catch(ex){}}
...
Zoom.Load = function() {
    ...
    while (_g1 < _g) {
        var i = _g1++;
        var item = params[i];
        if (item.key == "img") Zoom.imgSrc = item.value;
        else if (item.key == "bookId") Zoom.bookId = item.value;
        else if (item.key == "page") Zoom.pageNum = item.value;
        else if (item.key == "pw") Zoom.pageWidth = Std.parseFloat(item.value);
        else if (item.key == "ph") Zoom.pageHeight = Std.parseFloat(item.value);
        else if (item.key == "bookTitle") {
            Zoom.bookTitle = item.value;
            Zoom.bookTitle = StringTools.urlDecode(Zoom.bookTitle)
        } else if (item.key == "bbv") Zoom.bbv = item.value;
        else if (item.key == "ua") Zoom.analyticsUA = item.value;
        else if (item.key == "pcode") Zoom.pcode = item.value
    }
...
Zoom.renderVideos = function() {
    ...
    while (_g1 < _g) {
        ...
        if (item.youtubeId == null || item.youtubeId == "") dom.innerHTML += core.HtmlHelper.toRectVideoHtml(item, Zoom.xOffset + item.x * Zoom.xScale, Zoom.yOffset + item.y * Zoom.yScale, item.width * Zoom.xScale, item.height * Zoom.yScale);
        else dom.innerHTML += core.HtmlHelper.toRectYoutubeVideoHtml(item, Zoom.xOffset + item.x * Zoom.xScale, Zoom.yOffset + item.y * Zoom.yScale, item.width * Zoom.xScale, item.height * Zoom.yScale)
    }
}
...
core.ButtonInfo.prototype = {
        ...
        case "":
            if (this.destination != null) {
                if (this.destination.indexOf("page:") == 0) {
                    ...
                    if (RunTime.flipBook != null) RunTime.flipBook.turnToPage(num - 1);
                    else Zoom.zoomOut(num - 1)
                    ...
                    if (fun == "content") RunTime.flipBook.onContentsClick(null);
                    else if (fun == "thumb") RunTime.flipBook.onThumbsClick(null);
                    else if (fun == "showtxt") RunTime.flipBook.onShowTxtClick(null);
                    else if (fun == "highlight") RunTime.flipBook.onButtonMaskClick(null);
                    else if (fun == "bookmark") RunTime.flipBook.onButtonBookmark(null);
                    else if (fun == "notes") RunTime.flipBook.onButtonNoteClick(null);
                    else if (fun == "autoflip") RunTime.flipBook.onAutoFlipClick(null);
                    else if (fun == "download") RunTime.onDownloadClick(null);
                    else if (fun == "fliptofront") RunTime.flipBook.turnToFirstPage(null);
                    else if (fun == "flipleft") RunTime.flipBook.turnToPrevPage(null);
                    else if (fun == "flipright") RunTime.flipBook.turnToNextPage(null);
                    else if (fun == "fliptoback") RunTime.flipBook.turnToLastPage(null)
                } else {
                    RunTime.logClickLink(this.destination);
                    if ("_self" == this.target) js.Lib.window.location.href = this.destination;
                    else js.Lib.window.open(this.destination, this.target)
                }
            }
            break;
        case "image":
            ...
            core.HtmlHelper.toPopupImageHtml(this,
            function(txt) {
                js.Lib.document.getElementById("cvsOthers").innerHTML = txt;
                var timer = new haxe.Timer(100);
                timer.run = function() {
                    haxe.Log.trace("zoomComplete", {
                        fileName: "ButtonInfo.hx",
                        lineNumber: 243,
                        className: "core.ButtonInfo",
                        methodName: "click"
                    });
                    timer.stop();
    ...
    loadToRect: function(ctx, x, y, w, h) {
        if (w > 0 && h > 0) {
            if (this.text == "") ctx.drawImage(this._imagePage, 0, 0, this._imagePage.width, this._imagePage.height, x, y, w, h);
            else {
                ctx.save();
...
core.HighLight.prototype = {
    ...
    DataTransform: function() {
        ...
        if (RunTime.singlePage) {} else if (RunTime.book.rightToLeft) {
            if (this.tx > RunTime.clientWidth / 2) dp = this.getLeftDrawParams();
            else dp = this.getRightDrawParams()
        } else if (this.tx > RunTime.clientWidth / 2) dp = this.getRightDrawParams();
        else dp = this.getLeftDrawParams();
        ...
        haxe.Log.trace("x=" + this.x + ",y=" + this.y + ",width=" + this.width + ",height=" + this.height, {
            fileName: "HighLight.hx",
            lineNumber: 191,
...
core.HotLink=function(){this.target="_blank";this.opacity=0.8;this.pageLayoutType=0;this.color="#333333";this.scale=1;this.offsetX=0;this.offsetY=0};
...
core.HtmlHelper.toBookmarksHtml = function(bookmarks, singleMode, lbEnable, rbEnable) {
    ...
    if (singleMode) s += "<button onclick=\"addBookmark(0)\">Add Bookmark</button>";
        ...
        if (lbEnable) s += "<button onclick=\"addBookmark(-1)\">Add Left Bookmark</button>";
        else s += "<button disabled=\"disabled\">Add Left Bookmark</button>";
        if (rbEnable) s += "<button onclick=\"addBookmark(1)\">Add Right Bookmark</button>";
...
core.HtmlHelper.toPopupImageHtml = function(item, success) {
    ...
    if (item.popupWidth != null && item.popupHeight != null) {
        ...
        haxe.Log.trace(s, {
            ...
            lineNumber: 360,
            className: "core.HtmlHelper",
            methodName: "toPopupImageHtml"
        })
    } else {
        s = "";
...
core.NoteIcon.prototype = {
    ...
    DataTransform: function() {
        ...
        this.height = this.theight / (dp.dh / dp.sh);
        haxe.Log.trace("x=" + this.x + ",y=" + this.y + ",width=" + this.width + ",height=" + this.height, {
            fileName: "NoteIcon.hx",
            lineNumber: 193,
            className: "core.NoteIcon",
            methodName: "DataTransform"
        })
    },
    save: function() {
...
core.Page.prototype = {
    ...
    drawImageCore: function(offset) {
        ...
        } else if (offset > 0) this.clipImage(this.ctx, this._imagePage, dp.sx, dp.sy, dp.sw * (1 - offset), dp.sh, dp.dx + dp.dw * offset, dp.dy, dp.dw * (1 - offset), dp.dh);
        else {
            offset = -offset;
...
core.VideoInfo.prototype = {
    ...
    toHtml: function() {
        ...
        var ww = this.width * (dp.dw / dp.sw);
        var hh = this.height * (dp.dh / dp.sh);
        if (this.youtubeId != null && this.youtubeId != "") return core.HtmlHelper.toRectYoutubeVideoHtml(this, xx, yy, ww, hh);
...
haxe.xml._Fast.NodeAccess = function(x){this.__x = x;};
haxe.xml._Fast.NodeAccess.__name__ = true;
haxe.xml._Fast.NodeAccess.prototype={resolve:function(name){var x=this.__x.elementsNamed(name).next();if(x==null){var xname=this.__x.nodeType==Xml.Document?"Document":this.__x.getNodeName();throw xname+" is missing element "+name;}return new haxe.xml.Fast(x)},__class__:haxe.xml._Fast.NodeAccess}
haxe.xml._Fast.AttribAccess = function(x){this.__x = x;};
haxe.xml._Fast.AttribAccess.__name__ = true;
eval(function(p,a,c,k,e,r){e=function(c){return c.toString(36)};if('0'.replace(0,e)==0){while(c--)r[e(c)]=k[c];k=[function(e){return r[e]||e}];e=function(){return'[0-24-9a]'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('4.5.6.7.prototype={resolve:function(0){8(1.2.nodeType==Xml.Document)9"Cannot access document a "+0;var v=1.2.get(0);8(v==null)9 1.2.getNodeName()+" is missing a "+0;return v},__class__:4.5.6.7}',[],11,'name|this|__x||haxe|xml|_Fast|AttribAccess|if|throw|attribute'.split('|'),0,{}))
haxe.xml._Fast.HasAttribAccess = function(x){this.__x = x;};
haxe.xml._Fast.HasAttribAccess.__name__ = true;
haxe.xml._Fast.HasAttribAccess.prototype={resolve:function(name){if(this.__x.nodeType==Xml.Document)throw"Cannot access document attribute "+name;return this.__x.exists(name)},__class__:haxe.xml._Fast.HasAttribAccess}
haxe.xml._Fast.HasNodeAccess=function(x){this.__x=x};
haxe.xml._Fast.HasNodeAccess.__name__ = true;
haxe.xml._Fast.HasNodeAccess.prototype={resolve:function(name){return this.__x.elementsNamed(name).hasNext()},__class__:haxe.xml._Fast.HasNodeAccess}
haxe.xml._Fast.NodeListAccess = function(x){this.__x = x;};
haxe.xml._Fast.NodeListAccess.__name__ = true;
haxe.xml._Fast.NodeListAccess.prototype={resolve:function(name){var l=new List();var $it0=this.__x.elementsNamed(name);while($it0.hasNext()){var x=$it0.next();l.add(new haxe.xml.Fast(x))}return l},__class__:haxe.xml._Fast.NodeListAccess}
haxe.xml.Fast=function(x){if(x.nodeType!=Xml.Document&&x.nodeType!=Xml.Element)throw"Invalid nodeType "+Std.string(x.nodeType);this.x=x;this.node=new haxe.xml._Fast.NodeAccess(x);this.nodes=new haxe.xml._Fast.NodeListAccess(x);this.att=new haxe.xml._Fast.AttribAccess(x);this.has=new haxe.xml._Fast.HasAttribAccess(x);this.hasNode=new haxe.xml._Fast.HasNodeAccess(x)};
